...
public class WrapExpression extends CommandExpression{
	final static String myCommand = "wrap";

	WrapExpression(List<Expression> operands) {
		super(operands);
	}
	...
	public static class WrapFactory extends CommandFactory{
		...
		public Expression parseExpression(String input) {
			return new WrapExpression(this.findOperands(input));
		}
